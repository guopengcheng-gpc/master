...
function wbzl() {
	...
	var days = [month +'月', month1 + '月', month2 +'月'];
	var data = [
		[0, 0, threeMusicNum[0].酷狗[month]],
		[0, 1, threeMusicNum[0].酷狗[month1]],
		[0, 2, threeMusicNum[0].酷狗[month2]],
		//[0, 3, 8],
		[1, 0, threeMusicNum[0].酷我音乐[month]],
		[1, 1, threeMusicNum[0].酷我音乐[month1]],
		[1, 2, threeMusicNum[0].酷我音乐[month2]],
		//[1, 3, 9],
		[2, 0, threeMusicNum[0].网易云音乐[month]],
		[2, 1, threeMusicNum[0].网易云音乐[month1]],
		[2, 2, threeMusicNum[0].网易云音乐[month2]],
		//[2, 3, 8],
		/*[3, 0, 6],
		[3, 1, 7],
		[3, 2, 4],
...
function wwbzl() {
	...
	var data = [{
		name: musicAuthorNum[0][0].author,
		value: musicAuthorNum[0][0].num
	}, {
        name: musicAuthorNum[0][1].author,
        value: musicAuthorNum[0][1].num
	}, {
        name: musicAuthorNum[0][2].author,
        value: musicAuthorNum[0][2].num
	}, {
        name: musicAuthorNum[0][3].author,
        value: musicAuthorNum[0][3].num
	}, {
        name: musicAuthorNum[0][4].author,
        value: musicAuthorNum[0][4].num
	}, ];
	var offsetData = [
		[80, 53],
		[35, 73],
...
function sbj() {
	...
	for (var i = 0; i < 100; i++) {
		...
		date.push(getTime(Math.round(new Date()
			.getTime() / 1000) - i))
	}
	option = {
		title: [{
...
function dbj() {
	...
	setInterval(function() {
		option.series[0].data[0].value = (Math.random() * 30)
			.toFixed(2) - 0;
		option.series[1].data[0].value = (Math.random() * 8)
			.toFixed(2) - 0;
		option.series[2].data[0].value = (Math.random() * 300)
			.toFixed(2) - 0;
		option.series[3].data[0].value = (Math.random() * 2)
			.toFixed(2) - 0;
